        ...
        $row_count = 0;
           foreach ($rows as $key => $row)
           {
               ...
               if($row->filter()->isNotEmpty())
               {
                   ...
                   {
                        $row['product_sku'] = generateSkuProduct();
                       /*$row_valid = 0;
                       $temp_error_array = [
                           "row_index" => $key + 1 + 1,
                           "column_index" => "B",
...
//                        }
                        ...
                        if(1) // if($sale_permission)
                        {
                            ...
                            if(!$parent_product_status)
                            {
                                ...
                                $product->created_by_admin_id = Auth::id();
                               ...
                               // $product_attributes =  $product_attribute_set->attributes()->pluck('attributes.id')->toArray();
                                ...
                                if(!$combination_exists)
                                {
                                    ...
                                    if($cost_status && $product_type_status)
                                    {
                                        ...
                                        $product_variant->created_by_admin_id = Auth::id();
                                        $product_variant->updated_by_admin_id = Auth::id();
                                        ...
                                        $stock->created_by_admin_id = Auth::id();
                                        $stock->updated_by_admin_id = Auth::id();
                                        $stock->save();
                                        ...
                                        $stock_history->created_by_admin_id = Auth::id();
                                        $stock_history->updated_by_admin_id = Auth::id();
                                        ...
                                        $product_for_auction_or_sale->created_by_admin_id = Auth::id();
                                        $product_for_auction_or_sale->updated_by_admin_id = Auth::id();

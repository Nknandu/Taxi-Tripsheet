...
final class Style
{
    ...
    public function writeError(Throwable $throwable): void
    {
        ...
        $writer->ignoreFilesIn([
            ...
            '/bin\/pest/',
            '/user\/pestphp\/pest/',
            '/user\/phpspec\/prophecy-phpunit/',
            '/user\/phpspec\/prophecy/',
            '/user\/phpunit\/phpunit\/src/',
            '/user\/mockery\/mockery/',
            '/user\/laravel\/dusk/',
            '/user\/laravel\/framework\/src\/Illuminate\/Testing/',
            '/user\/laravel\/framework\/src\/Illuminate\/Foundation\/Testing/',
            '/user\/symfony\/framework-bundle\/Test/',
            '/user\/symfony\/phpunit-bridge/',
            '/user\/symfony\/dom-crawler/',
            '/user\/symfony\/browser-kit/',
            '/user\/symfony\/css-selector/',
            '/user\/bin\/.phpunit/',
            '/bin\/.phpunit/',
            '/user\/bin\/simple-phpunit/',
            '/bin\/phpunit/',
            '/user\/coduo\/php-matcher\/src\/PHPUnit/',
            '/user\/sulu\/sulu\/src\/Sulu\/Bundle\/TestBundle\/Testing/',
            '/user\/webmozart\/assert/',
        ]);

...
class TestCommand extends Command
{
    ...
    {
        if ($this->usingPest()) {
            $command = $this->option('parallel') ? ['user/pestphp/pest/bin/pest', '--parallel'] : ['user/pestphp/pest/bin/pest'];
        } else {
            $command = $this->option('parallel') ? ['user/brianium/paratest/bin/paratest'] : ['user/phpunit/phpunit/phpunit'];
        }

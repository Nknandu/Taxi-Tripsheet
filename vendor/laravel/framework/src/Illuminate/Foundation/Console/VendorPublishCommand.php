...
class VendorPublishCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'user:publish
     ...
     * @deprecated
     */
    protected static $defaultName = 'user:publish';
     ...
     * @var string
     */
    protected $description = 'Publish any publishable assets from user packages';

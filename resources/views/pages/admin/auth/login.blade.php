                    ...
                    <form class="form w-100" novalidate="novalidate" id="admin_login_form" action="#">
                        ...
                        <div class="card-body">
                            ...
                            <div class="text-start mb-10">
                                ...
                                <!--end::Title-->
                                <!--begin::Text-->
                                <div class="text-gray-400 fw-semibold fs-6" data-kt-translate="general-desc">Welcome To Fragmentor Admin Panel</div>
                                <!--end::Link-->
                            </div>
                            <!--begin::Heading-->
                            <!--begin::Input group=-->
...
{{--                        </div>--}}
        ...
        <!--end::Aside-->
        <!--begin::Body-->
        <div class="d-none d-lg-flex flex-lg-row-fluid w-50 bgi-size-cover bgi-position-y-center bgi-position-x-start bgi-no-repeat" style="background-image: url({{ asset('assets/media/auth/bg_new.jpg') }})"></div>
        <!--begin::Body-->
    </div>

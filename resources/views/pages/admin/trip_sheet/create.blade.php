...
@push('breadcrumbs')
    <!--begin::Item-->
    <li class="breadcrumb-item text-muted"><a href="{{ route('admin.kit_libraries.index') }}"
            class="text-muted text-hover-primary">Kit Libraries</a></li>
    <!--end::Item-->
    <!--begin::Item-->
                ...
                <div class="col-md-12 col-lg-12 col-xl-12 col-xxl-12 mb-md-5 mb-xl-10">
                    <div class="card">
                        ...
                        <div class="card-body pt-0">
                            <form class="form" action="#" id="addKitLibraryForm" enctype="multipart/form-data"
                                method="POST">
                                <!--begin::Modal body-->
                                <div class="modal-body">
                                    <div class="row g-9 mb-7">
                                        <div class="position-relative w-md-1000px me-md-6 col-md-6 input-group">
                                            <span class="input-group-text" id="basic-addon1">
                                                <i class="bi bi-person-circle"></i>
                                            </span>
                                            <input type="text" class="form-control" placeholder="Driver Name"
                                                aria-label="Driver Name" aria-describedby="basic-addon1" />
                                        </div>
                                        <div class="position-relative w-md-1000px me-md-6 col-md-6 input-group">
                                            <span class="input-group-text" id="basic-addon1">
                                                <i class="bi bi-person-circle"></i>
                                            </span>
                                            <input type="url" class="form-control" placeholder="Preview Link"
                                                name="preview_link">
                                ...
                                {{-- <div class="modal-body py-10 px-lg-17">
                                    <div class="row g-9 mb-7">
                                        <div class="col-md-6 input-group fv-row fv-plugins-icon-container">
                                            <span class="input-group-text" id="basic-addon1">
                                                <i class="bi bi-person-circle"></i>
                                            </span>
                                        ...
                                        <div class="col-md-6 fv-row fv-plugins-icon-container">
                                            ...
                                            <select class="form-select" id="kit_type" name="kit_type"
                                                data-control="select2" data-placeholder="Select Any"
                                        ...
                                        <div class="col-md-12 fv-row fv-plugins-icon-container">
                                            ...
                                            <select class="form-select" id="tags" name="tags[]" data-control="select2"
                                                data-placeholder="Select Any" data-allow-clear="true" multiple="multiple">
                                                <option></option>
                                        ...
                                        <div class="col-md-12 fv-row fv-plugins-icon-container">
                                            ...
                                            <select class="form-select" id="packages" name="packages[]"
                                                data-control="select2" data-placeholder="Select Any" data-allow-clear="true"
                                                multiple="multiple">
                                                <option></option>
                                        ...
                                        <div class="col-md-6 fv-row fv-plugins-icon-container">
                                            <label class="required fs-6 fw-semibold mb-2">Image (1200px X 800px)</label>
                                            <br>
                                        ...
                                        <div class="col-md-6 fv-row fv-plugins-icon-container">
                                            <label class="required fs-6 fw-semibold mb-2">Cover Image (1200px X
                                                400px)</label> <br>
                                            <div class="image-input image-input-empty" data-kt-image-input="true"
                                                style="background-image: url('{{ asset('assets/media/svg/files/blank-image.svg') }}')">
                                                <div class="image-input-wrapper w-125px h-125px"></div>
                                        ...
                                        <div class="col-md-12 fv-row fv-plugins-icon-container">
                                            ...
                                            <div class="dropzone-wrapper">
                                                ...
                                                <input type="file" name="file" id="dropzoneExcel" class="dropzone"
                                                    accept=".json">
                                            </div>
                                            <div class="fv-plugins-message-container invalid-feedback"></div>
                                        </div>
                                                    ...
                                                    <div data-repeater-item class="mb-8">
                                                        <div class="form-group row">
                                                            <div class="col-md-3">
                                                                ...
                                                                <input type="text" name="kit_library[title][]"
...
@push('head-scripts')
    ...
    <style>
        ...
        .preview-zone .box,
        .preview-zone-image .box,
        .preview-zone-video .box {
            box-shadow: none;
            border-radius: 0;
            margin-bottom: 0;
        }
